...
This pattern removes all hardcoded IDs and supports unlimited diagrams per page. For the full implementation (including smart fit, pinch zoom, and shared drag state), use `../targets/page/exemplars/mermaid-flowchart.html` as the canonical source.
